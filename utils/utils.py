...
from . import google_utils  #  torch_utils, google_utils
...
def plot_results(output='.', start=0, stop=0, bucket='', id=(), labels=()):  # from utils.utils import *; plot_results()
    ...
    fig.tight_layout()
    ax[1].legend()
    fig.savefig(output+'/results.png', dpi=200)
